...
class AINewsLetterAgents():
    def editor_agent(self):
        return Agent(
            ...
            ot only informs but also engages and inspires the readers.""",
    ...
    def news_analyzer_agent(self):
        return Agent(
            ...
            backstory="""With a critical eye and a knack for distilling complex information,your
            analysis of AI news stories, making them accessible and engaging for our audience.""",
            tools= [SearchTools.search_internet],
            verbose=True,
            allow_delegation=True,
        )
    ...
    def newsletter_compiler_agent(self):
        return Agent(
            ...
            backstory="""As the final architect of the newsletter, you meticulously arrange an
